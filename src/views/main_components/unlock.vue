            ...
            <div class="unlock-input-con">
                <div class="unlock-input-overflow-con">
                    <div class="unlock-overflow-body" :style="{right: inputLeft}">
                        <input ref="inputEle" v-model="username" class="unlock-input" type="text" placeholder="账号同登录账号" />
...
export default {
    ...
    methods: {
        ...
        handleUnlock () {
            if (Cookies.get('user') === this.username) {
                this.avatorLeft = '0px';
                ...
                this.$Message.error('账号错误,请重新输入。如果忘了账号，清除浏览器缓存重新登录即可。');
            }
        },
        unlockMousedown () {
